...
public class SvgFeComponentTransfer extends SvgElement {
    ...
    public static final String TAG_NAME = "feComponentTransfer";
     ...
     */
    SvgFeComponentTransfer(final String namespaceURI, final String qualifiedName, final SgmlPage page,
