...
--
-- Table structure for table `recommender_comment_wordnet_topic_analysis`
--

DROP TABLE IF EXISTS `recommender_comment_wordnet_topic_analysis`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recommender_comment_wordnet_topic_analysis` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=131776 DEFAULT CHARSET=utf8;
