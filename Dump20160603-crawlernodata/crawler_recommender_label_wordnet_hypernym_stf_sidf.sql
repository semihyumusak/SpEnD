...
--
-- Table structure for table `recommender_label_wordnet_hypernym_stf_sidf`
--

DROP TABLE IF EXISTS `recommender_label_wordnet_hypernym_stf_sidf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recommender_label_wordnet_hypernym_stf_sidf` (
  ...
  KEY `termid` (`termid`)
) ENGINE=InnoDB AUTO_INCREMENT=115198 DEFAULT CHARSET=utf8;
