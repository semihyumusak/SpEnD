...
--
-- Table structure for table `recommender_comment_wordnet_topic_stf_sidf_level`
--

DROP TABLE IF EXISTS `recommender_comment_wordnet_topic_stf_sidf_level`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recommender_comment_wordnet_topic_stf_sidf_level` (
  ...
  KEY `term` (`term`)
) ENGINE=InnoDB AUTO_INCREMENT=71824 DEFAULT CHARSET=utf8;
