...
--
-- Table structure for table `recommender_comment_wordnet_topic_anlys_scr_lvl_ti_t20`
--

DROP TABLE IF EXISTS `recommender_comment_wordnet_topic_anlys_scr_lvl_ti_t20`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recommender_comment_wordnet_topic_anlys_scr_lvl_ti_t20` (
